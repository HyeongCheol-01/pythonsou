...
print('수량*단가*세금 한 결과를 출력하는 함수작성')
...
print()
# 2분기에는 su*dan에 대한 tax는 0.05qnrhk
q2 = outer2(0.05) # inner3의 주소 기억
result3 = q2(5,50000)
print('result3 : ', result3)
result4 = q2(2,10000)
print('result4 : ', result4)

print('\n일급함수 : 함수 안의 함수, 인자로 함수를 전달, 반환값이 함수')
def func1(a,b):
    return(a+b)
...
print('\n축약함수 (Lanmbda function)')  # :이름이 없는 한 줄짜리함수
#형식 : lambda 매개변수들 ,,, : 반환식 <== 리턴없이 결과 반환
def hapFunc(x,y):
    return x+ y
print(hapFunc(1,2))
#람다로 표헌
...
# 문) 1~100 사이의 정수 중 5의 배수이거나 7의 배수만 출력
