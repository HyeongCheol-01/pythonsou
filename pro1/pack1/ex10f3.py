...
print()
def func3(w, h, **other): # ** : dict로 받겠다는 의미
    print(f'몸무게 : {w}, 키 : {h}')
    print(f'기타 : {other}')

func3(80,180, irum = '신기루', nai = 23)
# func3(80,180, {'irum' : '신기루', 'nai' : 23})  # TypeError: func3() takes 2 positional arguments but 3 were given
