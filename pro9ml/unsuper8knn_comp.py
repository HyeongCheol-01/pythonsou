...
# k=3 이므로 71, 82, 31 번 자료가 분류에 참여함. 새로운 자료와 거리는 0.223 ,0.3, 0.43588989

print('\n 비지도 학습 - K평균 비계층 군집 알고리즘')
...
print(f'KMean: 새로운 값은 {clu_pred}로 분류됨')

print()
# 군집 모델 성능 파악
pred_cluster = kmeansModel.predict(test_x)
print('pred_cluster:', pred_cluster)  # [2 1 0 2 2 1 2 0 2 2 0 1 1 1 1 2 0 2 2 0 1 2 1 0 0 0 0 0 1 1 1 1 2 1 1 2 2 1]
...
np_arr[np_arr==5] = 1   # 군집 5를 1(virginica)로 변경
print('np_arr :',np_arr)
