...
# 분석대상의 집단 수에 의해서 도립성 검정과 동질성 검정으로 나눈다
# 독립성 : 동일 집단의 두 변인 학력수준과 대학진학 여부를 대상
# 독립성 검정은 두 변수 사이의 연관성을 검정한다

# 실습
#교육수준(독립변수, x)과 흡연율(종속변수, y) 간의 관련성 분석.
...
# chi2:18.9109, p:0.0008182, dof:4
print("excepted : \n", expected)    # 예측된 기대도수

# 판정1 : 유의수준:0.05 > p:0.0008182 이므로 귀무가설이 기각
# 교육 수준과 흡연율 간에 관계가 있다. smoke.csv(수집자료)는 우연히 발생된 자료가 아니다.

# 판정2 : chi2:18.910915, dof : 4, critical value:
...
# 유의수준 0.05 > p value 0.003880 이므로 귀무가설 기각
# 성별과 음료 선호는 서로 관련 있다.
