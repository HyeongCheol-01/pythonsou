...
# :모집단에서 추출한 표본정보를 이용하여 모집단의 다양한 특성을 과학적으로 추론할 수 있는 분석

# 단일 표본 t검정(One-sample t-test)
# 정규분포의 표본에 대한 기대값을 조사하는 검정방법이다.
# 예상평균값과 표본 자료 간에 평균의 차이를 검정
# 독립변수 : 범주형, 종속변수 : 연속형
...
print(result)
# statistic=-0.22139444, pvalue=0.8356, df=4
# 해석 : 유의수준 0.05 < pvalue 0.8356 귀무가설 채택

print()
result2 = stats.ttest_1samp(one_sample, popmean=165)
print(result2)
# statistic=3.18467395, pvalue=0.0333856, df=4
