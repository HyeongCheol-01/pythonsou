...
# 실습) 두 가지 교육방법에 따른 평균 시험 점수에 대한 검정 수행 two_sample.csv

# 귀무 : 두 가지 교육방법에 따른 평균 시험 점수에 차이가 있다.
# 대립 : 두 가지 교육방법에 따른 평균 시험 점수에 차이가 없다.
...
# 정규성 검정
print('score1:',stats.shapiro(score1))  # p=0.36799
print('score2:',stats.shapiro(score2))  # p=0.67142
...
print('등분산성 : ', levene(score1, score2).pvalue)     #  0.4568  등분산성 만족

result = stats.ttest_ind(score1, score2, equal_var=True)
print('result :', result)
# statistic=-0.1964938, pvalue=0.845053, df=48
