...
# 귀무 : 어느 음식점의 매출 데이터는 강수 여부에 딸 매출액 평균에 차이가 없다.
# 대립 : 어느 음식점의 매출 데이터는 강수 여부에 딸 매출액 평균에 차이가 있다.
...
print()
# sales: YMD 20190514, wt: tm 2018-06-01
...
#  [  18000       1] ...
tg1 = sp[sp[:,1] == 0, 0]   # 집단 1 : 비 안 올 때 매출액
tg2 = sp[sp[:,1] == 1, 0]   # 집단 2 : 비 올 때 매출액
print(tg1[:3])  # [     0  50000 125000]
print(tg2[:3])  # [ 18000 274000 318000]
print('tg1(맑은날) 매출액 평균 : ', np.mean(tg1))   # 761040
print('tg2(비온날) 매출액 평균 : ', np.mean(tg2))   # 757331
